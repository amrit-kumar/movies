...
for i in mylist:
    print(i['99popularity'])
    sql = " INSERT INTO  movies_schema.users_movies (popularity,director,genre,imdb_score,name)  VALUES (%s, %s,%s, %s,%s)"

    # val = (' 82.0','Victor Fleming','["Drama"," Romance"," War"]',8.2,'movie3')
    val=(i['99popularity'],i['director'],str(i['genre']),i['imdb_score'],i['name'])
